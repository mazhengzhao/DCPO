...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        # TODO:if sampling make temperature=1.0
        ...
        with self.update_sampling_params(**kwargs):
            ...
            response = []
            # TODO: new add to return the log_prob of valid data
            rollout_log_probs = []
        ...
        batch = TensorDict(
            {
                ...
                # 'response_log_probs': rollout_log_probs,  # we will recompute old log prob with actor
        ...
        # TODO: new add to return the log_prob of valid data
        if is_validate:
            batch["response_log_probs"] = rollout_log_probs
